...
type JeopardyGameBoxScore struct {
	...
	R1CorrectPercentage    float64 `gorm:"type:decimal(5,2)" json:"r1_correct_percentage"`
	R1Dd1                  int     `json:"r1_dd1"`
	R1Dd2                  int     `json:"r1_dd2"`
	R1Eor                  int     `json:"r1_eor"`
	R2Att                  int     `json:"r2_att"`
	R2Buz                  int     `json:"r2_buz"`
	R2BuzPercentage        float64 `gorm:"type:decimal(5,2)" json:"r2_buz_percentage"`
	R2Correct              int     `json:"r2_correct"`
	R2Incorrect            int     `json:"r2_incorrect"`
	R2CorrectPercentage    float64 `gorm:"type:decimal(5,2)" json:"r2_correct_percentage"`
	...
	BuzPercentageTotal     float64 `gorm:"type:decimal(5,2)" json:"buz_percentage_total"`
	CorrectTotal           int     `json:"correct_total"`
	IncorrectTotal         int     `json:"incorrect_total"`
	CorrectPercentageTotal float64 `gorm:"type:decimal(5,2)" json:"correct_percentage_total"`
	DdTotal                int     `json:"dd_total"`
	DdPercentageTotal      float64 `gorm:"type:decimal(5,2)" json:"dd_percentage_total"`
	TotalFjCorrect         int     `json:"total_fj_correct"`
	TotalFjIncorrect       int     `json:"total_fj_incorrect"`
	TotalFjPercentage      float64 `gorm:"type:decimal(5,2)" json:"total_fj_percentage"`
...
type JeopardyGameBoxScoreTotal struct {
	...
	CorrectPercentage   float64 `gorm:"type:decimal(5,2)" json:"correct_percentage"`
